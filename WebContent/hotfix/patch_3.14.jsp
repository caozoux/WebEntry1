...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
				...
				<div id="col-md5-6">
					<div class="box box-info">
							<div class="box-header with-border">
							  <h3 class="box-title">追加kpatch到新的分支</h3>
							</div>
							<form class="form-horizontal">
								<div class="box-body">
									<label for="exampleInputEmail1"> AK ID</label>
									<input type="text" class="form-control" name="akid">						
										  <div class="checkbox">
											<label><input type="checkbox" name="version">ali2000</label>
											<label><input type="checkbox" name="version">ali2001</label>
											<label><input type="checkbox" name="version">ali2002</label>
											<label><input type="checkbox" name="version">ali2003</label>
											<label><input type="checkbox" name="version">ali2004</label>
											<label><input type="checkbox" name="version">ali2005</label>
											<label><input type="checkbox" name="version">ali2006</label>
											<label><input type="checkbox" name="version">ali2007</label>
											<label><input type="checkbox" name="version">ali2008</label>
											<label><input type="checkbox" name="version">ali2009</label>
										  </div>
										  <div class="checkbox">
											<label><input type="checkbox" name="version">ali2010</label>
											<label><input type="checkbox" name="version">ali2011</label>
											<label><input type="checkbox" name="version">ali2012</label>
											<label><input type="checkbox" name="version">ali2013</label>
											<label><input type="checkbox" name="version">ali2014</label>
											<label><input type="checkbox" name="version">ali2015</label>
											<label><input type="checkbox" name="version">ali2016</label>
											<label><input type="checkbox" name="version">ali2017</label>
											<label><input type="checkbox" name="version">ali2018</label>
										  </div>
		...
		<div class="row">
			<!-- handle submit patch for hotfix -->
			<section class="col-lg-7 connectedSortable ui-sortable">
				<div id="col-md5-6">
					<div class="box box-info">
							<div class="box-header with-border">
							  <h3 class="box-title">提交patch</h3>
							</div>
							<form class="form-horizontal">
								<div class="box-body">							
										...
										<p class="help-block">Example block-level help text here.</p>				 
											  <div class="checkbox">
												<label><input type="checkbox" name="version1" >ali2000</label>
												<label><input type="checkbox" name="version1" >ali2001</label>
												<label><input type="checkbox" name="version1" >ali2002</label>
												<label><input type="checkbox" name="version1" >ali2003</label>
												<label><input type="checkbox" name="version1" >ali2004</label>
												<label><input type="checkbox" name="version1" >ali2005</label>
												<label><input type="checkbox" name="version1" >ali2006</label>
												<label><input type="checkbox" name="version1" >ali2007</label>
												<label><input type="checkbox" name="version1" >ali2008</label>
												<label><input type="checkbox" name="version1" >ali2009</label>
											  </div>
											  <div class="checkbox">
												<label><input type="checkbox" name="version1" >ali2010</label>
												<label><input type="checkbox" name="version1" >ali2011</label>
												<label><input type="checkbox" name="version1" >ali2012</label>
												<label><input type="checkbox" name="version1" >ali2013</label>
												<label><input type="checkbox" name="version1" >ali2014</label>
												<label><input type="checkbox" name="version1" >ali2015</label>
												<label><input type="checkbox" name="version1" >ali2016</label>
												<label><input type="checkbox" name="version1" >ali2017</label>
												<label><input type="checkbox" name="version"1 >ali2018</label>
											  </div>
