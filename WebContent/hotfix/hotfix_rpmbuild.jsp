...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0../resource/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1../resource/css/ionicons.min.css">
  <!-- Theme style -->
			  ...
			  <div class="box box-primary">
				...
				<div class="box-body pad table-responsive">
				  <table class="table text-center">
					...
					<tr>
					  <td>
						<button type="button" class="btn btn-block btn-success">打包</button>
					  </td>
					  <td>
						<button type="button" class="btn btn-block btn-success">转测试包</button>
					  </td>
					  <td>
						<button type="button" class="btn btn-block btn-success">转正式包</button>
					  </td>
					</tr>
				  </tbody></table>
				</div>
				...
				<div class="box-body">
					...
					<div class="progress progress-sm active">
						<div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 1%">
						<span class="sr-only">20% Complete</span>
						</div>
					</div>
				</div>
...
<script src="../resource/css/dist/js/pages/dashboard.js"></script>
